      ...
      <div class=" md:flex md:items-center md:justify-between">
        <div class="mt-8  md:mt-0">
          <div class="flex flow-row justify-left gap-4 pb-2">
            <NuxtLink v-for="item in navLinks" :to="item.href" :key="item.text"
          ...
          <p class="text-base text-gray-400">
            Handren dental app for managing daily tasks, patients history and more.
          </p>
          <p class="text-left text-base text-gray-400">&copy;2023 Darya Ibrahim </p>
        </div>
        <div class="mt-8  md:mt-0">
        </div>
...
const socialLinks = ref([
  {
    name: 'Facebook',
    href: 'https://github.com/SamEdwardes/plaintext-editor',
